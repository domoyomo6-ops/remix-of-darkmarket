...
CREATE TABLE public.products (
    ...
    category public.product_category DEFAULT 'software'::public.product_category NOT NULL,
    image_url text,
    file_url text,
...
CREATE TABLE public.site_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    site_password text DEFAULT 'welcome123'::text NOT NULL,
    require_membership boolean DEFAULT true NOT NULL,
    telegram_admin_enabled boolean DEFAULT false NOT NULL,
    telegram_customer_enabled boolean DEFAULT false NOT NULL,
