        ...
        <div className="container mx-auto px-4 py-6 sm:py-8 relative z-20">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
              <Button 
                className="crt-button px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-mono group w-full sm:w-auto"
              ...
              <Button 
                variant="outline"
                className="px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-mono border-primary/50 text-primary hover:bg-primary/10 w-full sm:w-auto"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-12">
            {[
              ...
              { label: 'SECURITY', value: 'MAX', icon: Terminal },
            ].map((stat) => (
              <div key={stat.label} className="panel-3d rounded-lg p-3 sm:p-4 text-center">
          ...
          <div className="mb-8 sm:mb-12">
            ...
            {announcements.length === 0 ? (
              <div className="panel-3d rounded-lg p-6 sm:p-8 text-center">
              ...
              <div className="grid gap-3 sm:gap-4">
                {announcements.map((announcement) => (
                  <div 
                    key={announcement.id}
                    className={`panel-3d rounded-lg p-4 sm:p-5 border-l-4 ${getPriorityClass(announcement.priority)} hover:bg-primary/5 transition-colors cursor-pointer`}
                  >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-2 mb-1">
                          ...
                          {announcement.priority >= 5 && (
                            <Badge className="bg-red-500/30 text-red-400 border-0 text-xs font-mono flex-shrink-0">
                              URGENT
                            </Badge>
                          )}
                        </div>
          ...
          <div className="mb-8 sm:mb-12">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              ...
              <Button 
                variant="ghost" 
                className="font-mono text-primary hover:bg-primary/10 text-xs sm:text-sm px-2 sm:px-4"
                onClick={() => navigate('/stock')}
              >
            ...
            {loading ? (
              ...
              <div className="panel-3d rounded-lg p-8 sm:p-12 text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {products.map((product) => (
                  <div 
                    key={product.id}
                    className="panel-3d rounded-lg overflow-hidden group cursor-pointer hover:border-primary/50 transition-all"
                  ...
                  >
                    ...
                    <div className="aspect-video bg-gradient-to-br from-primary/20 to-transparent relative overflow-hidden">
                      ...
                      <div className="absolute top-2 sm:top-3 left-2 sm:left-3">
                        <Badge 
                          variant="outline" 
                          className={`text-xs font-mono uppercase ${getCategoryBadgeClass(product.category)}`}
                        >
                          {product.category}
                        </Badge>
                      </div>
          ...
          <div className="panel-3d rounded-lg p-6 sm:p-8 text-center bg-gradient-to-r from-primary/10 via-transparent to-primary/10">
            ...
            <Button 
              className="crt-button px-6 sm:px-8 py-5 sm:py-6 text-base sm:text-lg font-mono w-full sm:w-auto"
              onClick={() => navigate('/stock')}
            >
              <Terminal className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
              ENTER THE CATALOG
