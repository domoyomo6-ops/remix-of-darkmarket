...
export default function Homepage() {
  ...
  return <MainLayout>
      ...
      <div className="min-h-screen relative">
        ...
        <div className="pointer-events-none fixed inset-0 z-0 bg-[radial-gradient(circle_at_top,#0f172a,transparent_45%),radial-gradient(circle_at_center,#0b1220,transparent_30%),radial-gradient(circle_at_bottom,#02030a,transparent_60%)] opacity-90" />
        <div className="pointer-events-none fixed inset-0 z-0 bg-[radial-gradient(circle_at_30%_20%,rgba(56,189,248,0.2),transparent_40%),radial-gradient(circle_at_70%_70%,rgba(14,165,233,0.15),transparent_45%)]" />
        <div className="pointer-events-none fixed inset-0 z-0 bg-gradient-to-b from-[#05060b]/50 via-transparent to-[#02030a]/90" />
        <div className="pointer-events-none fixed inset-0 z-0 bg-[radial-gradient(circle_at_center,transparent_30%,rgba(2,3,10,0.85)_100%)]" />
